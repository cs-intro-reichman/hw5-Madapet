...
public class Scrabble {
	...
	public static int wordScore(String word) {
		...
		for (int i = 0; i < word.length(); i++) {
			...
			score += SCRABBLE_LETTER_VALUES[(int) (ch - 97)];
		}
	...
	public static String createHand() {
		String new_hand = "";
		new_hand = MyString.randomStringOfLetters(HAND_SIZE - 2);
		new_hand = MyString.insertRandomly('a', new_hand);
		new_hand = MyString.insertRandomly('e', new_hand);
		return new_hand;
	}
